...
namespace ByteBankProject
{
    ...
    public class Program
    {
        ...
        private static string ValidarCpf(string cpfUsuario)
        {
            for (int i = 0; i < cpfUsuario.Length; i++)
            {
                if (cpfUsuario.Length != 11)
                {
                    Console.WriteLine("NUMERO DE CPF INVALIDO, DIGITE OS 11 NUMEROS DO SEU CPF");
        ...
        private static string GetPass() //colocando caracter especial na senha
        {
            ...
            do
            {
                ...
                switch (opcaoMenuPrincipal)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Console.WriteLine("\nEssas são as contas listadas no nosso BYTE BANK: \n");
